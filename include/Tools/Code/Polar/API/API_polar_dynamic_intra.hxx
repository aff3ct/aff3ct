...
template <int N_ELMTS>
void API_polar_dynamic_intra<B,R,F,G,G0,H,XO,FI,GI,G0I,HI,XOI>
::g(const R *__restrict l_a, const R *__restrict l_b, const B *__restrict s_a, R *__restrict l_c,
              const int n_elmts)
{
...
template <int N_ELMTS>
void API_polar_dynamic_intra<B,R,F,G,G0,H,XO,FI,GI,G0I,HI,XOI>
::xo(const B *__restrict s_a, const B *__restrict s_b, B *__restrict s_c,
               const int n_elmts)
{
