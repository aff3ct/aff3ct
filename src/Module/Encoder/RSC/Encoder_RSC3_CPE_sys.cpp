...
#ifdef MULTI_PREC
template class Encoder_RSC3_CPE_sys<B_8>;
template class Encoder_RSC3_CPE_sys<B_16>;
template class Encoder_RSC3_CPE_sys<B_32>;
template class Encoder_RSC3_CPE_sys<B_64>;
#else
template class Encoder_RSC3_CPE_sys<B>;
#endif
// ==================================================================================== explicit template instantiation
