...
#ifdef MULTI_PREC
template class Decoder_LDPC_BP_layered_log_sum_product<B_8,Q_8>;
template class Decoder_LDPC_BP_layered_log_sum_product<B_16,Q_16>;
template class Decoder_LDPC_BP_layered_log_sum_product<B_32,Q_32>;
template class Decoder_LDPC_BP_layered_log_sum_product<B_64,Q_64>;
#else
template class Decoder_LDPC_BP_layered_log_sum_product<B,Q>;
#endif
// ==================================================================================== explicit template instantiation
