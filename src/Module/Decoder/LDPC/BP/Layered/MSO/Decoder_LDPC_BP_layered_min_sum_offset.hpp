...
class Decoder_LDPC_BP_layered_min_sum_offset : public Decoder_LDPC_BP_layered<B,R>
{
private:
...
public:
	Decoder_LDPC_BP_layered_min_sum_offset(const int &K, const int &N, const int& n_ite,
	                                       ...
	                                       const std::string name = "Decoder_LDPC_BP_layered_min_sum_offset");
	virtual ~Decoder_LDPC_BP_layered_min_sum_offset();
