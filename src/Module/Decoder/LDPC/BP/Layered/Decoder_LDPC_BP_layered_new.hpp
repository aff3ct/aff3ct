#ifndef DECODER_LDPC_BP_LAYERED_NEW_HPP_
#define DECODER_LDPC_BP_LAYERED_NEW_HPP_
...
class Decoder_LDPC_BP_layered_new : public Decoder_LDPC_BP<B,R>
{
protected:
...
public:
	...
	virtual ~Decoder_LDPC_BP_layered_new();
...
#include "Decoder_LDPC_BP_layered_new.hxx"

#endif /* DECODER_LDPC_BP_LAYERED_NEW_HPP_ */
