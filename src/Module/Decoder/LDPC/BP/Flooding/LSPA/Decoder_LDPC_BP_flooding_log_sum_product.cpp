...
: Decoder_LDPC_BP_flooding<B,R>(K, N, n_ite, alist_data, info_bits_pos, enable_syndrome, n_frames, name),
...
template class aff3ct::module::Decoder_LDPC_BP_flooding_log_sum_product<B_16,Q_16>;
template class aff3ct::module::Decoder_LDPC_BP_flooding_log_sum_product<B_32,Q_32>;
template class aff3ct::module::Decoder_LDPC_BP_flooding_log_sum_product<B_64,Q_64>;
#else
template class aff3ct::module::Decoder_LDPC_BP_flooding_log_sum_product<B,Q>;
#endif
// ==================================================================================== explicit template instantiation
