#ifndef Decoder_LDPC_BP_flooding_new_NEW_HPP_
#define Decoder_LDPC_BP_flooding_new_NEW_HPP_
...
class Decoder_LDPC_BP_flooding_new : public Decoder_LDPC_BP<B,R>
{
public:
	void reset();
...
protected:
	...
	virtual ~Decoder_LDPC_BP_flooding_new();
...
#include "Decoder_LDPC_BP_flooding_new.hxx"

#endif /* Decoder_LDPC_BP_flooding_new_NEW_HPP_ */
