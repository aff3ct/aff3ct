...
#ifdef MULTI_PREC
template class Decoder_turbo_fast_CA<B_8,Q_8>;
template class Decoder_turbo_fast_CA<B_16,Q_16>;
template class Decoder_turbo_fast_CA<B_32,Q_32>;
template class Decoder_turbo_fast_CA<B_64,Q_64>;
#else
template class Decoder_turbo_fast_CA<B,Q>;
#endif
// ==================================================================================== explicit template instantiation
