...
class Interleaver_ARP_DVB_RCS1 : public Interleaver<T>
{
private:
	int p0, p1, p2, p3;
...
public:
	Interleaver_ARP_DVB_RCS1(const int size, const int n_frames = 1,
	                         const std::string name = "Interleaver_ARP_DVB_RCS1")
