...
#ifdef MULTI_PREC
template class aff3ct::module::Modulator_BPSK_fast<B_8,R_8,R_8>;
template class aff3ct::module::Modulator_BPSK_fast<B_8,R_8,Q_8>;
template class aff3ct::module::Modulator_BPSK_fast<B_16,R_16,R_16>;
template class aff3ct::module::Modulator_BPSK_fast<B_16,R_16,Q_16>;
template class aff3ct::module::Modulator_BPSK_fast<B_32,R_32,R_32>;
template class aff3ct::module::Modulator_BPSK_fast<B_64,R_64,R_64>;
#else
template class aff3ct::module::Modulator_BPSK_fast<B,R,Q>;
#if !defined(PREC_32_BIT) && !defined(PREC_64_BIT)
template class aff3ct::module::Modulator_BPSK_fast<B,R,R>;
#endif
#endif
// ==================================================================================== explicit template instantiation
