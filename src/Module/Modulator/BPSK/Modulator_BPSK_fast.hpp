...
public:
	Modulator_BPSK_fast(const int N, const R sigma, const mipp::vector<R> &H, const bool disable_sig2 = false,
	                    const int n_frames = 1, const std::string name = "Modulator_BPSK_fast");
