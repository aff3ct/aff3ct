  ...
  Codec_SISO_SIHO<B,Q>(enc_params.K, enc_params.N_cw, enc_params.N_cw, enc_params.tail_length, enc_params.n_frames)
{
	...
	try
	{
		std::shared_ptr<Decoder_SISO_SIHO<B,Q>> decoder_siso_siho(factory::Decoder_NO::build_siso<B,Q>(dec_params, this->get_encoder()));
	...
	{
		std::shared_ptr<Decoder_SIHO<B,Q>> dec(factory::Decoder_NO::build<B,Q>(dec_params, this->get_encoder()));
