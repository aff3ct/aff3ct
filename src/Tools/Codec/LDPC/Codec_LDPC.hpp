...
public:
	...
	module::Encoder_LDPC<B>*   build_encoder(const int tid = 0, const module::Interleaver<B>* itl = nullptr);
...
private:
	module::Decoder_SISO_SIHO<B,Q>* _build_siso(const int tid = 0, const module::Interleaver<Q>* itl = nullptr,
	                                                                     module::CRC        <B>* crc = nullptr);
};
}
}
