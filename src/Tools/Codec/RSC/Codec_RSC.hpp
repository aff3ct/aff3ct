...
public:
	...
	module::Encoder_RSC_sys  <B  >* build_encoder     (const int tid = 0, const module::Interleaver<B>* itl = nullptr);
	module::Decoder_SISO_SIHO<B,Q>* build_decoder_siso(const int tid = 0, const module::Interleaver<Q>* itl = nullptr,
