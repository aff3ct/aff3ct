...
void Factory_simulation_EXIT::store_args(const Arguments_reader& ar, parameters &params)
{
...
void Factory_simulation_EXIT::header(params_list& head_sim, const parameters& params)
{
