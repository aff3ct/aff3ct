...
void Factory_terminal::store_args(const Arguments_reader& ar, terminal_params &params)
{
	// ------------------------------------------------------------------------------------------------------ terminal
...
void Factory_terminal_BFER::store_args(const Arguments_reader& ar, terminal_params_BFER &params)
{
...
void Factory_terminal_EXIT::store_args(const Arguments_reader& ar, terminal_params_EXIT &params)
{
	Factory_terminal::store_args(ar, params);
}
