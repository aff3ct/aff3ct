...
struct Factory_decoder_polar_gen : public Factory_decoder_common
{
	struct decoder_parameters_polar_gen : decoder_parameters
	{
		virtual ~decoder_parameters_polar_gen() {}
...
//		int         L             = 8;
	...
	static void store_args(const Arguments_reader& ar, decoder_parameters_polar_gen &params);
	static void group_args(Arguments_reader::arg_grp& ar);

	static void header(Header::params_list& head_dec, Header::params_list& head_cde, const decoder_parameters_polar_gen& params);
