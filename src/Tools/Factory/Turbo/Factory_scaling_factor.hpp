...
{
	struct scaling_factor_parameters
	{
	...
	static Scaling_factor<B,Q>* build(const scaling_factor_parameters& params, const int n_ite);

	static void build_args(Arguments_reader::arg_map &req_args, Arguments_reader::arg_map &opt_args);
	static void store_args(const Arguments_reader& ar, scaling_factor_parameters &params);
	static void group_args(Arguments_reader::arg_grp& ar);

	static void header(Header::params_list& head_sf, const scaling_factor_parameters& params);
};
}
}
