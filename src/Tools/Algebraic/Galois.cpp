...
void Galois
//::Select_Polynomial(mipp::vector<int>& p)
::Select_Polynomial()
{
    for(int i=1; i<m; i++)
        p[i] = 0;
...
void Galois
//::Generate_GF(mipp::vector<int>& alpha_to, mipp::vector<int>& index_of)
::Generate_GF()
{
	register int i, mask;
...
void Galois
//::Compute_BCH_Generator_Polynomial(int d, int K, mipp::vector<int>& g)
::Compute_BCH_Generator_Polynomial()
{
