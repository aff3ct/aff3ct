...
template <int T = polar_node_t::STANDARD>
class Pattern_polar : public Pattern_polar_i
{
protected:
...
public:
	...
	{
		return new Pattern_polar<polar_node_t::STANDARD>(N, node);
	}

	virtual ~Pattern_polar() {}

	virtual polar_node_t type()       const { return STANDARD;   }
