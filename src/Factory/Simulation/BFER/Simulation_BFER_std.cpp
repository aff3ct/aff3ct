...
#else
	return new simulation::Simulation_BFER_std_threads<B,R,Q>(params, codec);
#endif
}
...
#ifdef MULTI_PREC
template aff3ct::simulation::Simulation_BFER_std<B_8 ,R_8 ,Q_8 >* aff3ct::factory::Simulation_BFER_std::build<B_8 ,R_8 ,Q_8 >(const aff3ct::factory::Simulation_BFER_std::parameters&, aff3ct::tools::Codec<B_8 ,Q_8 >&);
template aff3ct::simulation::Simulation_BFER_std<B_16,R_16,Q_16>* aff3ct::factory::Simulation_BFER_std::build<B_16,R_16,Q_16>(const aff3ct::factory::Simulation_BFER_std::parameters&, aff3ct::tools::Codec<B_16,Q_16>&);
template aff3ct::simulation::Simulation_BFER_std<B_32,R_32,Q_32>* aff3ct::factory::Simulation_BFER_std::build<B_32,R_32,Q_32>(const aff3ct::factory::Simulation_BFER_std::parameters&, aff3ct::tools::Codec<B_32,Q_32>&);
template aff3ct::simulation::Simulation_BFER_std<B_64,R_64,Q_64>* aff3ct::factory::Simulation_BFER_std::build<B_64,R_64,Q_64>(const aff3ct::factory::Simulation_BFER_std::parameters&, aff3ct::tools::Codec<B_64,Q_64>&);
#else
template aff3ct::simulation::Simulation_BFER_std<B,R,Q>* aff3ct::factory::Simulation_BFER_std::build<B,R,Q>(const aff3ct::factory::Simulation_BFER_std::parameters&, aff3ct::tools::Codec<B,Q>&);
#endif
// ==================================================================================== explicit template instantiation
