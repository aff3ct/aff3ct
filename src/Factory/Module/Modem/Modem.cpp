...
template <typename B, typename R, typename Q>
module::Modem<B,R,Q>* Modem::parameters
::build(std::shared_ptr<const tools::Distributions<R>> dist, const std::string& chn_type) const
{
...
::build(const parameters &params, std::shared_ptr<const tools::Distributions<R>> dist, const std::string& chn_type)
{
...
#ifdef MULTI_PREC
template aff3ct::module::Modem<B_8 ,R_8 ,Q_8 >* aff3ct::factory::Modem::parameters::build<B_8 ,R_8 ,Q_8 >(std::shared_ptr<const tools::Distributions<R_8 >>, const std::string&) const;
template aff3ct::module::Modem<B_8 ,R_8 ,R_8 >* aff3ct::factory::Modem::parameters::build<B_8 ,R_8 ,R_8 >(std::shared_ptr<const tools::Distributions<R_8 >>, const std::string&) const;
template aff3ct::module::Modem<B_16,R_16,Q_16>* aff3ct::factory::Modem::parameters::build<B_16,R_16,Q_16>(std::shared_ptr<const tools::Distributions<R_16>>, const std::string&) const;
template aff3ct::module::Modem<B_16,R_16,R_16>* aff3ct::factory::Modem::parameters::build<B_16,R_16,R_16>(std::shared_ptr<const tools::Distributions<R_16>>, const std::string&) const;
template aff3ct::module::Modem<B_32,R_32,Q_32>* aff3ct::factory::Modem::parameters::build<B_32,R_32,Q_32>(std::shared_ptr<const tools::Distributions<R_32>>, const std::string&) const;
template aff3ct::module::Modem<B_64,R_64,Q_64>* aff3ct::factory::Modem::parameters::build<B_64,R_64,Q_64>(std::shared_ptr<const tools::Distributions<R_64>>, const std::string&) const;
template aff3ct::module::Modem<B_8 ,R_8 ,Q_8 >* aff3ct::factory::Modem::build<B_8 ,R_8 ,Q_8 >(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R_8 >>, const std::string&);
template aff3ct::module::Modem<B_8 ,R_8 ,R_8 >* aff3ct::factory::Modem::build<B_8 ,R_8 ,R_8 >(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R_8 >>, const std::string&);
template aff3ct::module::Modem<B_16,R_16,Q_16>* aff3ct::factory::Modem::build<B_16,R_16,Q_16>(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R_16>>, const std::string&);
template aff3ct::module::Modem<B_16,R_16,R_16>* aff3ct::factory::Modem::build<B_16,R_16,R_16>(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R_16>>, const std::string&);
template aff3ct::module::Modem<B_32,R_32,Q_32>* aff3ct::factory::Modem::build<B_32,R_32,Q_32>(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R_32>>, const std::string&);
template aff3ct::module::Modem<B_64,R_64,Q_64>* aff3ct::factory::Modem::build<B_64,R_64,Q_64>(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R_64>>, const std::string&);
#else
template aff3ct::module::Modem<B,R,Q>* aff3ct::factory::Modem::parameters::build<B,R,Q>(std::shared_ptr<const tools::Distributions<R>>, const std::string&) const;
template aff3ct::module::Modem<B,R,Q>* aff3ct::factory::Modem::build<B,R,Q>(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R>>, const std::string&);
#if !defined(PREC_32_BIT) && !defined(PREC_64_BIT)
template aff3ct::module::Modem<B,R,R>* aff3ct::factory::Modem::parameters::build<B,R,R>(std::shared_ptr<const tools::Distributions<R>>, const std::string&) const;
template aff3ct::module::Modem<B,R,R>* aff3ct::factory::Modem::build<B,R,R>(const aff3ct::factory::Modem::parameters&, std::shared_ptr<const tools::Distributions<R>>, const std::string&);
#endif
#endif
// ==================================================================================== explicit template instantiation
