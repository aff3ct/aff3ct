...
::build(const parameters &params)
{
	...
	else if (params.type == "DVB-RCS1") return new module::Interleaver_ARP_DVB_RCS1 <T>(params.size,                                             params.n_frames);
	else if (params.type == "DVB-RCS2") return new module::Interleaver_ARP_DVB_RCS2 <T>(params.size,                                             params.n_frames);
