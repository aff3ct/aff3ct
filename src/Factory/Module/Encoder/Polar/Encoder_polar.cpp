...
void
Encoder_polar ::get_description(cli::Argument_map_info& args) const
{
    ...
    cli::add_options(args.at({ p + "-type" }), 0, "POLAR", "POLAR_UNPACKED");
...
Encoder_polar ::build(const std::vector<bool>& frozen_bits) const
{
    ...
    if (this->type == "POLAR_UNPACKED" && !this->systematic)
...
template aff3ct::module::Encoder_polar<B_8>*
aff3ct::factory::Encoder_polar::build<B_8>(const std::vector<bool>&) const;
template aff3ct::module::Encoder_polar<B_16>*
aff3ct::factory::Encoder_polar::build<B_16>(const std::vector<bool>&) const;
template aff3ct::module::Encoder_polar<B_32>*
aff3ct::factory::Encoder_polar::build<B_32>(const std::vector<bool>&) const;
template aff3ct::module::Encoder_polar<B_64>*
aff3ct::factory::Encoder_polar::build<B_64>(const std::vector<bool>&) const;
#else
template aff3ct::module::Encoder_polar<B>*
aff3ct::factory::Encoder_polar::build<B>(const std::vector<bool>&) const;
#endif
// ==================================================================================== explicit template instantiation
