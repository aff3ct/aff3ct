...
#ifdef MULTI_PREC
template aff3ct::module::Encoder_sys<B_8 >* aff3ct::factory::Encoder_repetition::parameters::build<B_8 >() const;
template aff3ct::module::Encoder_sys<B_16>* aff3ct::factory::Encoder_repetition::parameters::build<B_16>() const;
template aff3ct::module::Encoder_sys<B_32>* aff3ct::factory::Encoder_repetition::parameters::build<B_32>() const;
template aff3ct::module::Encoder_sys<B_64>* aff3ct::factory::Encoder_repetition::parameters::build<B_64>() const;
...
#else
template aff3ct::module::Encoder_sys<B>* aff3ct::factory::Encoder_repetition::parameters::build<B>() const;
