...
#include "Module/Decoder/Turbo_product_code/Chase_pyndiah/Decoder_chase_pyndiah.hpp"
...
Decoder_turbo_product_code::parameters
::parameters(const std::string &prefix)
: Decoder::parameters(Decoder_turbo_product_code_name, prefix),
...
Decoder_turbo_product_code::parameters* Decoder_turbo_product_code::parameters
::clone() const
{
	auto clone = new Decoder_turbo_product_code::parameters(*this);
...
std::vector<std::string> Decoder_turbo_product_code::parameters
::get_names() const
{
...
void Decoder_turbo_product_code::parameters
