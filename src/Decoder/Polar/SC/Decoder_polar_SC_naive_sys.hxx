...
::Decoder_polar_SC_naive_sys(const int& K, const int& N, const mipp::vector<B>& frozen_bits, const std::string name)
: Decoder_polar_SC_naive<B,R,F,G,H>(K, N, frozen_bits, name)
{
}
