...
{
private:
	/*!< The number of characters of the largest parameter name. */
	int max_n_chars;
	/*!< An internal map to store a string associated to a type. */
	std::unordered_map<std::type_index,std::string> type_names;
	/*!< A generic simulation pointer to allocate a specific simulation. */
	Simulation *simu;

protected:
	/*!< An argument reader to manage the parsing and the documentation of the command line parameters. */
	Arguments_reader ar;
	/*!< A structure of parameters to store and pass to the simulation. */
	parameters params;
	/*!< The dedicated stream in which the launcher writes the parameters. */
	std::ostream &stream;
	...
	/*!< List of the optional arguments, syntax is the following:
