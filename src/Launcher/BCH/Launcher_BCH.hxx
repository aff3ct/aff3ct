...
::store_args()
{
	...
	tools::Factory_encoder_BCH<B  >::store_args(this->ar, *m_enc);
	tools::Factory_decoder_BCH<B,Q>::store_args(this->ar, *m_dec, this->m_chain_params->sim.K, this->m_chain_params->sim.N);
}
