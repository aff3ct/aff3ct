...
::store_args()
{
	...
	tools::Factory_encoder_LDPC::store_args(this->ar, *m_enc, this->m_chain_params->sim->K, this->m_chain_params->sim->N, this->m_chain_params->sim->inter_frame_level);
...
::print_header()
{
	tools::Factory_encoder_LDPC::header(this->pl_enc, this->pl_cde, *m_enc);
