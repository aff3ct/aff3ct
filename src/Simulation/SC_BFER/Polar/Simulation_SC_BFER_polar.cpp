...
#include "Simulation_SC_BFER_polar.hpp"

template <typename B, typename R, typename Q>
Simulation_SC_BFER_polar<B,R,Q>
...
template <typename B, typename R, typename Q>
Puncturer<B,Q>* Simulation_SC_BFER_polar<B,R,Q>
::build_puncturer()
{
...
template <typename B, typename R, typename Q>
Encoder<B>* Simulation_SC_BFER_polar<B,R,Q>
::build_encoder()
{
...
template <typename B, typename R, typename Q>
Decoder<B,Q>* Simulation_SC_BFER_polar<B,R,Q>
::build_decoder()
{
	if (is_generated_decoder)
...
#ifdef MULTI_PREC
template class Simulation_SC_BFER_polar<B_8,R_8,Q_8>;
template class Simulation_SC_BFER_polar<B_16,R_16,Q_16>;
template class Simulation_SC_BFER_polar<B_32,R_32,Q_32>;
template class Simulation_SC_BFER_polar<B_64,R_64,Q_64>;
#else
template class Simulation_SC_BFER_polar<B,R,Q>;
#endif
// ==================================================================================== explicit template instantiation
