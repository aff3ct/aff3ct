...
#ifdef MULTI_PREC
template class aff3ct::simulation::Simulation_BFERI_LDPC<B_8,R_8,Q_8>;
template class aff3ct::simulation::Simulation_BFERI_LDPC<B_16,R_16,Q_16>;
template class aff3ct::simulation::Simulation_BFERI_LDPC<B_32,R_32,Q_32>;
template class aff3ct::simulation::Simulation_BFERI_LDPC<B_64,R_64,Q_64>;
#else
template class aff3ct::simulation::Simulation_BFERI_LDPC<B,R,Q>;
#endif
// ==================================================================================== explicit template instantiation
