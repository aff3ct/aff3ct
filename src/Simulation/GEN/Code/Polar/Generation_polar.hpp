...
//	const typename tools::Factory_simulation_GEN::chain_parameters_GEN &params;
//
//	// data vector
...
//
//public:
//	Generation_polar(const typename tools::Factory_simulation_GEN::chain_parameters_GEN& params);
//
