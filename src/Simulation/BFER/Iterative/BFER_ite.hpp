...
protected:
	...
	std::vector<std::unique_ptr<tools ::Codec_SISO_SIHO <B,  Q>>> codec;
...
public:
	explicit BFER_ite(const factory::BFER_ite &params_BFER_ite);
...
protected:
	...
	virtual std::unique_ptr<tools ::Codec_SISO_SIHO <B,Q  >> build_codec      (const int tid = 0);
