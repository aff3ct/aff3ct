...
#include "Simulation_RA_debug.hpp"

template <typename B, typename R, typename Q>
Simulation_RA_debug<B,R,Q>
::Simulation_RA_debug(const t_simulation_param& simu_params,
                      const t_code_param&       code_params,
                      const t_encoder_param&    enco_params,
                      const t_channel_param&    chan_params,
                      const t_decoder_param&    deco_params)
: Simulation_RA<B,R,Q>(simu_params, code_params, enco_params, chan_params, deco_params), ft(std::clog)
{
}
...
template <typename B, typename R, typename Q>
void Simulation_RA_debug<B,R,Q>
::simulation_loop()
{
...
#ifdef MULTI_PREC
template class Simulation_RA_debug<B_8,R_8,Q_8>;
template class Simulation_RA_debug<B_16,R_16,Q_16>;
template class Simulation_RA_debug<B_32,R_32,Q_32>;
template class Simulation_RA_debug<B_64,R_64,Q_64>;
#else
template class Simulation_RA_debug<B,R,Q>;
#endif
// ==================================================================================== explicit template instantiation