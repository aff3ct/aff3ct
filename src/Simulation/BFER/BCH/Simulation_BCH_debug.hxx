...
#include "Simulation_BCH_debug.hpp"

template <typename B, typename R, typename Q>
Simulation_BCH_debug<B,R,Q>
::Simulation_BCH_debug(const t_simulation_param& simu_params,
                      const t_code_param&       code_params,
                      const t_encoder_param&    enco_params,
                      const t_channel_param&    chan_params,
                      const t_decoder_param&    deco_params)
: Simulation_BCH<B,R,Q>(simu_params, code_params, enco_params, chan_params, deco_params)
{
}

template <typename B, typename R, typename Q>
Simulation_BCH_debug<B,R,Q>
::~Simulation_BCH_debug()
{
}

template <typename B, typename R, typename Q>
void Simulation_BCH_debug<B,R,Q>
::simulation_loop()
{
