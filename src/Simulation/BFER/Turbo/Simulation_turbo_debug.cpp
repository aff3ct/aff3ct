...
#include "Simulation_turbo_debug.hpp"

template <typename B, typename R, typename Q, typename QD>
Simulation_turbo_debug<B,R,Q,QD>
::Simulation_turbo_debug(const t_simulation_param& simu_params,
                   const t_code_param&       code_params,
                   const t_encoder_param&    enco_params,
                   const t_channel_param&    chan_params,
                   const t_decoder_param&    deco_params)
: Simulation_turbo<B,R,Q,QD>(simu_params, code_params, enco_params, chan_params, deco_params), ft(std::clog)
{
}

template <typename B, typename R, typename Q, typename QD>
Simulation_turbo_debug<B,R,Q,QD>
::~Simulation_turbo_debug()
{
}

template <typename B, typename R, typename Q, typename QD>
void Simulation_turbo_debug<B,R,Q,QD>
::simulation_loop()
{
...
#ifdef MULTI_PREC
template class Simulation_turbo_debug<B_8,R_8,Q_8,QD_8>;
template class Simulation_turbo_debug<B_16,R_16,Q_16,QD_16>;
template class Simulation_turbo_debug<B_32,R_32,Q_32,QD_32>;
template class Simulation_turbo_debug<B_64,R_64,Q_64,QD_64>;
#else
template class Simulation_turbo_debug<B,R,Q,QD>;
#endif
// ==================================================================================== explicit template instantiation