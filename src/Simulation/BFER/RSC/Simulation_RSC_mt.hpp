#ifndef SIMULATION_RSC_MT_HPP_
#define SIMULATION_RSC_MT_HPP_
...
class Simulation_RSC_mt : public Simulation
{
protected:
...
public:
	...
	virtual ~Simulation_RSC_mt();

	void launch();

protected:
	void snr_loop();
	static void build_communication_chain(Simulation_RSC_mt<B,R,Q,QD> *simu, const R& snr, const int tid = 0);
	static void simulation_Monte_Carlo(Simulation_RSC_mt<B,R,Q,QD> *simu, const R snr, const int tid);

protected:
	static void simulation_loop(Simulation_RSC_mt<B,R,Q,QD> *simu, const int tid = 0);
	static void time_reduction(Simulation_RSC_mt<B,R,Q,QD> *simu);
};

#endif /* SIMULATION_RSC_MT_HPP_ */