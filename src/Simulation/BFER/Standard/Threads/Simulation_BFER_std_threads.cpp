...
: Simulation_BFER_std<B,R,Q>(chain_params, codec),
  ...
  X_N2(this->simu_params.n_threads, mipp::vector<B>(this->chain_params.pct->N     * this->chain_params.pct->n_frames)),
  ...
  Y_N3(this->simu_params.n_threads, mipp::vector<R>(this->chain_params.mdm .N     * this->chain_params.mdm .n_frames)),
  Y_N4(this->simu_params.n_threads, mipp::vector<Q>(this->chain_params.qnt .size  * this->chain_params.qnt .n_frames)),
  Y_N5(this->simu_params.n_threads, mipp::vector<Q>(this->chain_params.pct->N_cw  * this->chain_params.pct->n_frames)),
  V_K1(this->simu_params.n_threads, mipp::vector<B>(this->chain_params.dec->K     * this->chain_params.dec->n_frames)),
  V_K2(this->simu_params.n_threads, mipp::vector<B>(this->chain_params.crc .K     * this->chain_params.crc .n_frames))
{
#ifdef ENABLE_MPI
