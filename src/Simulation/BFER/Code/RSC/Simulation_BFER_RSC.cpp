...
#ifdef MULTI_PREC
template class aff3ct::simulation::Simulation_BFER_RSC<B_8,R_8,Q_8,QD_8>;
template class aff3ct::simulation::Simulation_BFER_RSC<B_16,R_16,Q_16,QD_16>;
template class aff3ct::simulation::Simulation_BFER_RSC<B_32,R_32,Q_32,QD_32>;
template class aff3ct::simulation::Simulation_BFER_RSC<B_64,R_64,Q_64,QD_64>;
#else
template class aff3ct::simulation::Simulation_BFER_RSC<B,R,Q,QD>;
#endif
// ==================================================================================== explicit template instantiation
