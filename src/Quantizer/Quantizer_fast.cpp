...
::Quantizer_fast(const int N, const short& fixed_point_pos, const int n_frames, const std::string name)
: Quantizer<float,float>(N, n_frames, name.c_str()), val_max(0), val_min(0), fixed_point_pos(0), factor(0) {}

template <>
Quantizer_fast<double,double>
::Quantizer_fast(const int N, const short& fixed_point_pos, const int n_frames, const std::string name)
: Quantizer<double,double>(N, n_frames, name.c_str()), val_max(0), val_min(0), fixed_point_pos(0), factor(0) {}
